...
namespace sv
{
    ...
    public:
        ...
        cell (uint32_t i, const Point& p, uint32_t a_i) : index(i), point(p), agent_index(a_i)
        {
        }
        uint32_t index;
    ...
    public:
        ...
        cell_ptr cell_i() const { return arc_i->_cell; }
        cell_ptr cell_j() const { return arc_j->_cell; }
        cell_ptr cell_k() const { return arc_k->_cell; }
